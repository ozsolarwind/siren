...
def PlotPalette(keys, palette=15, black=False, lower=True):
    ...
    if palette == 15 or palette == '15':
        ...
        colours = [[0, 61, 48],
                   ...
                   [255, 204, 254],
                   [175, 255, 42]]
  #      order = [32, 42, 11, 43, 39, 21, 10, 15, 8, 37, 2, 17, 16, 38, 1, 27, 22, 34, 33, 3, 7, 44, 40, 23,
   #              5, 35, 30, 12, 14, 45, 47, 25, 9, 24, 46, 36, 13, 28, 20, 6, 26, 31, 29, 0, 4, 19, 41, 18]
        order = []
        for o in range(len(colours)):
            order.append(o)
